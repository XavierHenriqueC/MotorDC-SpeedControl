###########################################################################
## Makefile generated for component 'simulink_teste_rev3'. 
## 
## Makefile     : simulink_teste_rev3.mk
## Generated on : Sat Oct 08 10:58:10 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/simulink_teste_rev3.elf
...
PRODUCT_NAME              = simulink_teste_rev3
MAKEFILE                  = simulink_teste_rev3.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/hxc_h/OneDrive/Desktop/TRABAL~2
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/hxc_h/DOCUME~1/MATLAB/R2022b/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/simulink_teste_rev3.elf
...
DEFINES_STANDARD = -DMODEL=simulink_teste_rev3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/simulink_teste_rev3_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/simulink_teste_rev3_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/simulink_teste_rev3_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/simulink_teste_rev3_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


simulink_teste_rev3.o : $(START_DIR)/simulink_teste_rev3_ert_rtw/simulink_teste_rev3.c
	$(CC) $(CFLAGS) -o "$@" "$<"


simulink_teste_rev3_data.o : $(START_DIR)/simulink_teste_rev3_ert_rtw/simulink_teste_rev3_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
